...
public class ApiLinks {
    ...
    public static String GENERATE_OTP = BASE_URL + "otp/generate_otp.php";
    public static String VERIFY_OTP = BASE_URL + "otp/verify_otp.php";
    public static String RESEND_OTP = BASE_URL + "otp/verify_otp.php";
    public static String RESET_PASSWORD = BASE_URL + "apps/reset_password.php";
